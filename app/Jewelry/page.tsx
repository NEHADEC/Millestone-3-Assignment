...
export default function Jewelry() {
  const jewelryProducts = [
    ...
    { id: 4, name: 'Pearl Earrings', price: '$150.00', image: '/j-4.jpg', rating: 5 },
    { id: 5, name: 'Gold Bracelet', price: '$300.00', image: '/j-5.jpg', rating: 4 },
    { id: 6, name: 'Emerald Pendant', price: '$500.00', image: '/j-6.jpg', rating: 5 },
    { id: 7, name: 'Sapphire Earrings', price: '$400.00', image: '/j-13.jpg', rating: 5 },
    { id: 8, name: 'Ruby Necklace', price: '$750.00', image: '/j-8.jpg', rating: 5 },
    { id: 9, name: 'Platinum Ring', price: '$1,500.00', image: '/j-9.jpg', rating: 5 },
    { id: 10, name: 'Diamond Bracelet', price: '$1,100.00', image: '/j-10.jpeg', rating: 5 },
    { id: 11, name: 'Gold Earrings', price: '$250.00', image: '/j-11.jpg', rating: 4 },
    { id: 12, name: 'Crystal Brooch', price: '$95.00', image: '/j-12.jpg', rating: 4 },
  ];
