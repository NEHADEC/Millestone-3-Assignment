...
export default function Products() {
  const products = [
    ...
    { id: 7, name: 'Watch', price: '$150.00', image: '/c-7.jpg', rating: 5 },
    { id: 8, name: 'Backpack', price: '$65.00', image: '/c-8.jpg', rating: 4 },
    { id: 9, name: 'Sunglasses', price: '$45.00', image: '/c-9.jpg', rating: 5 },
    { id: 10, name: 'Belt', price: '$30.00', image: '/c=10.jpg', rating: 3 },
    { id: 11, name: 'Coat', price: '$200.00', image: '/c-11.jpeg', rating: 4 },
    { id: 12, name: 'Scarf', price: '$25.00', image: '/c-12.jpg', rating: 5 },
  ];
